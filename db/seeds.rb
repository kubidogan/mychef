...
carolin2 = User.create(username: "chef_carolin", email: "carolins@hotmail.com", password: "password", typeofuser: true, name: "Carolin S", cuisine: "Pas Du Sous", price: 2, address: "16 Rue de la Cr des Aides, 33000 Bordeaux, France", longitude: "44.83337938020759", latitude: "-0.5708682883575964", bio: "I carefully select my suppliers and ingredients to offer you a rich and authentic menu from the region" )
file = URI.open('https://res.cloudinary.com/dk3fbg9zm/image/upload/v1646408063/carolin_evbwcg.jpg')
...
kubi2 = User.create(username: "chef_kubi", email: "kubigdogan@hotmail.com", password: "password", typeofuser: true, name: "Kubi D", cuisine: "Self Employed", price: 3, address: "Northcote Rd, Langho, Blackburn BB6 8BE, United Kingdom", longitude: "53.80990428715672", latitude: "-2.4470293809563266", bio: "I draw inspiration from the beautiful Ribble Valley landscape to produce stunning dishes which showcase the wide range of incredible produce the region has to offer." )
file = URI.open('https://res.cloudinary.com/dk3fbg9zm/image/upload/v1646408783/profilepic_o5lvao.jpg')
...
jam = User.create(username: "jamieo", email: "jamieo@hotmail.com", password: "password", typeofuser: true, name: "Jamie Oliver", cuisine: "Jamie's Italian", price: 3, address: "Oude Waal 40, 1011 CE, Amsterdam, the Netherlands", longitude: "52.3724081867893", latitude: "4.905130155947044", bio: " The legend from Ready Steady Cook" )
