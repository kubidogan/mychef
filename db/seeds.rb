...
kubi2 = User.create(username: "chef_kubi", email: "kubigdogan@hotmail.com", password: "password", typeofuser: true, name: "Gordon Ramsay", cuisine: "Austrian", price: 3, address: "Northcote Rd, Langho, Blackburn BB6 8BE, United Kingdom", longitude: "53.80990428715672", latitude: "-2.4470293809563266", bio: "I draw inspiration from the beautiful Ribble Valley landscape to produce stunning dishes which showcase the wide range of incredible produce the region has to offer." )
file = URI.open('https://res.cloudinary.com/dk3fbg9zm/image/upload/v1646408783/profilepic_o5lvao.jpg')
kubi2.avatar.attach(io: file, filename: 'nes.jpg', content_type: 'image/jpg')
carolin2 = User.create(username: "chef_carolin", email: "carolins@hotmail.com", password: "password", typeofuser: true, name: "Jamie Oliver", cuisine: "French", price: 2, address: "16 Rue de la Cr des Aides, 33000 Bordeaux, France", longitude: "44.83337938020759", latitude: "-0.5708682883575964", bio: "I carefully select my suppliers and ingredients to offer you a rich and authentic menu from the region" )
file = URI.open('https://res.cloudinary.com/dk3fbg9zm/image/upload/v1646408063/carolin_evbwcg.jpg')
carolin2.avatar.attach(io: file, filename: 'nes.jpg', content_type: 'image/jpg')
david2 = User.create(username: "chef_david", email: "davidm@hotmail.com", password: "password", typeofuser: true, name: "Clare Smyth", cuisine: "Italian", price: 1, address: "92 Kensington Park Rd, London W11 2PN, United Kingdom", longitude: "51.51324223258976", latitude: "-0.2027338195841721", bio: "I am the Chef Patron of Core by David McGroarty-Manley which opened in 2017. Previously I was Chef Patron at Restaurant Gordon Ramsay from 2012 to 2016." )
file = URI.open('https://res.cloudinary.com/dk3fbg9zm/image/upload/v1646408063/david_bjvlgj.jpg')
david2.avatar.attach(io: file, filename: 'nes.jpg', content_type: 'image/jpg')
emma2 = User.create(username: "chef_emma", email: "emmac@hotmail.com", password: "password", typeofuser: true, name: "Chris Chan", cuisine: "British", price: 2, address: "Oude Waal 40, 1011 CE, Amsterdam, the Netherlands", longitude: "52.3724081867893", latitude: "4.905130155947044", bio: "I believe the origin of the ingredients tells me something about the taste of that ingredient, and contributes to a better-balanced nature in the long term. I mostly buy from organic farmers in the region because their sustainable way of working benefits the taste and nutritional value of the products they produce." )
file = URI.open('https://res.cloudinary.com/dk3fbg9zm/image/upload/v1646408064/emma_g4imoi.jpg')
